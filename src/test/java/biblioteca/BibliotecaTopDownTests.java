...
public class BibliotecaTopDownTests {
    Carte carte;
    Carte carte2;
    CartiRepoMock cr;
    ...
    @Test
    public void integrationTest_AddBook() {
        try {
            carte = new Carte();
            carte.setAnAparitie("1915");
            ...
            Assert.assertEquals(bc.getCarti().size(), 2);
        } finally {
    ...
    @Test
    public void integrationTest_CautaCarteDupaAutor() {
        try {
            carte = new Carte();
            carte.setAnAparitie("1915");
            carte.setCuvinteCheie(new ArrayList<>(Collections.singletonList("keyword")));
